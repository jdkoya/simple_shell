...
/**
 * enum quote_state - name of function
 * @QUOTE_NONE: prints no quotes
 * @QUOTE_WORD: prints string quotes
 * @QUOTE_DOUBLE: prints in double quotes
 * @QUOTE_SINGLE: prints in single quotes
 * @QUOTE_ESCAPE: quotes with a backslash
 */
